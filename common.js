...
const SCENE_THEMES = {
    ...
    casino:   { g1: '#7a1f2e', g2: '#2a1010', glow: 'rgba(212,175,55,.28)', walk: ['🎰','🂡','💰','🎲','🥂'], props: ['♠️','♥️','♦️','♣️'], fly: ['✨'] },
    pond:     { g1: '#123c52', g2: '#0a2434', glow: 'rgba(94,200,216,.26)', walk: ['🎣','🐟','🐠','🎏','🪣'], props: ['🫧','🌊','⭐'], fly: ['🐦'] },
    bluff:    { g1: '#3a2a4a', g2: '#1a1220', glow: 'rgba(200,150,255,.24)', walk: ['🃏','🤫','😏','👀','🎭'], props: ['❓','🂠','✨'], fly: ['🎈'] },
    prism:    { g1: '#1c1f2c', g2: '#12141c', glow: 'rgba(255,79,163,.24)', walk: ['🌈','🟥','🟨','🟩','🟦'], props: ['✨','🎴','⭐'], fly: ['🎈'] },
};
