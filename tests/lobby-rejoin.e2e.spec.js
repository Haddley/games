...
const { GAMES, PHONE, TV, openRoom, joinFresh, seatNames, seatCount } = require('./games');

// The per-game battery in connection-battery.e2e.spec.js now covers all nineteen. What is
// left here is the DEEP cases, on the games they were reported in: the exact Tic Tac Toe
// bracket and Last Laugh lobby from the photos, mid-game repeat rejoining, and the herdmind
// stall. A spread of the plain games stays as a sanity check on the shared table.
