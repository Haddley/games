...
test('TV-first: herds, pink cow, shepherd merge, podium', async ({ browser }) => {
    ...
    await expect(karen.locator('text=Farmer\'s Settings')).toBeVisible({ timeout: 30_000 });
    ...
    await expect(karen.locator('text=Farmer\'s Settings')).toBeVisible({ timeout: 15_000 });
