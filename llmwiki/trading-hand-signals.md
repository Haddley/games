...
- LIFFE's distinguishing feature was **visual, not gestural**: a carnival of **coloured firm jackets** (see [cornerthemarket-heritage.md](cornerthemarket-heritage.md)) so you identified the counterparty's firm by jacket colour rather than a firm gesture.
...
`cornerthemarket.html` renders the **quantity signal** (1–4 fingers, vertical) on the shout button,
