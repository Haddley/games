# letterstorm.html — Implementation Plan
...
Architecture mirrors `boggle.html` / `cornerthemarket.html`: single self-contained HTML file, PeerJS P2P
...
| Feature | boggle.html | letterstorm.html |
|---|---|---|
...
## Verification
1. `npm run dev` → open `/games/letterstorm.html` in 3+ tabs (host, guest, viewer)
